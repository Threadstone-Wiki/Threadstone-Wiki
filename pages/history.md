...
# Slimeblocks, tnt duping and pig spawner generation <a name="tnt-vs-pig"/>

TNT duplication and [pig spawner generation](chunk/population.md#moving-immovable-blocks) are opposite bugs.
...
In early 2017, before the technique for pulling spawners was discovered, Panda4994 and RedstoneSpire were working on a method for generating pig spawners, by causing an update suppression right after the spawner placement.
